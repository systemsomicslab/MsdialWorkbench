...
{
    /// <summary>
    /// HeatmapTest1.xaml の相互作用ロジック
    /// </summary>
    public partial class HeatmapTest1 : Page
    {
        public HeatmapTest1()
        {
            InitializeComponent();
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            var bean = getHeatmapTestVM(result);
            this.DataContext = bean;
            return;
        }

        private HeatmapTestVM getHeatmapTestVM(MultivariateAnalysisResult result)
        {
            var heatmapbean = new HeatmapTestVM(result.DistanceMatrix);
            return heatmapbean;
        }
