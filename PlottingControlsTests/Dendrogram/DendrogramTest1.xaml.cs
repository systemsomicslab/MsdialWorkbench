...
{
    /// <summary>
    /// DendrogramTest1.xaml の相互作用ロジック
    /// </summary>
    public partial class DendrogramTest1 : Page
    {
        public DendrogramTest1()
        {
            InitializeComponent();
        }
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            var vm = new DendrogramTestVM(result.Dendrogram, result.Root);
            this.DataContext = vm;
            return;
        }
