...
namespace Rfx.Riken.OsakaUniv
{
    public class PlotLabelBean
    {
        ...
        public PlotLabelBean() { }
        
        public PlotLabelBean(string label, double labelCoordinateX, double labelCoordinateY, SolidColorBrush labelBrush)
        {
            this.label = label;
