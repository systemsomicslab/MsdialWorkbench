...
namespace Riken.Metabolomics.StructureFinder.Property
{
    ...
    public sealed class CdkConverter
    {
        ...
        public static BondType ConvertToCSharpBondType(IBond.Order iOrder)
        {
            switch (iOrder.toString()) {
                case "SINGLE":
        ...
        public static BondDirection ConvertToCSharpBondDirection(IBond.Stereo iStereo)
        {
            switch (iStereo.toString()) {
                case "DOWN":
