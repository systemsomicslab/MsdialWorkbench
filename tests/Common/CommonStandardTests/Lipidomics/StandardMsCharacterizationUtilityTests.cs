    ...
    public class StandardMsCharacterizationUtilityTests
    {
        ...
        public static IEnumerable<object[]> GetDefaultCharacterizationResultForCeramidesTestData {
            get {
                ...
                var expected2 = new Lipid(Enum.LbmClass.SM, 100d, new PositionLevelChains(new SphingoChain(18, DoubleBond.CreateFromPosition(4), Oxidized.CreateFromPosition(1, 3)), new AcylChain(16, new DoubleBond(1), new Oxidized(0))));
