...
{
    [TestClass()]
    public class PositionLevelChainsTests
    {
        [DataTestMethod()]
        ...
        public static IEnumerable<object[]> EqualsTestData {
            get {
                ...
                ITotalChain chains1 = new PositionLevelChains(acyl160, acyl181),
                    chains2 = new PositionLevelChains(acyl181, acyl160),
                    chains3 = new PositionLevelChains(acyl160, acyl160),
                    chains4 = new PositionLevelChains(acyl161, acyl180),
                    chains5 = new TotalChain(34, 1, 0, 2, 0, 0),
                    chains6 = new MolecularSpeciesLevelChains(acyl160, acyl181),
                    chains7 = new PositionLevelChains(alkyl160, acyl181);
                yield return new object[] { chains1, chains1, true, };
                yield return new object[] { chains1, chains2, false, };
