...
{
    public static class ChromatogramPeakFeatureInterfaceTestHelper {
        public static void AreEqual(this Assert assert, IChromatogramPeakFeature expected, IChromatogramPeakFeature actual) {
