...
namespace CompMs.MsdialCore.Algorithm.Annotation.Tests
{
    ...
    public class FacadeMatchResultEvaluatorTests
    {
        ...
        public static IEnumerable<object[]> GetSelectTopHitTestDatas() {
            var result1A = new MsScanMatchResult { AnnotatorID = "A", Source = (SourceType)1, Priority = 1, TotalScore = 10, };
            var result2A = new MsScanMatchResult { AnnotatorID = "A", Source = (SourceType)1, Priority = 1, TotalScore = 20, };
            var result3A = new MsScanMatchResult { AnnotatorID = "A", Source = (SourceType)1, Priority = 2, TotalScore = 10, };
            var result4A = new MsScanMatchResult { AnnotatorID = "A", Source = (SourceType)1, Priority = 2, TotalScore = 20, };
            var result5A = new MsScanMatchResult { AnnotatorID = "A", Source = (SourceType)2, Priority = 1, TotalScore = 10, };
            var result6A = new MsScanMatchResult { AnnotatorID = "A", Source = (SourceType)2, Priority = 1, TotalScore = 20, };
            var result7A = new MsScanMatchResult { AnnotatorID = "A", Source = (SourceType)2, Priority = 2, TotalScore = 10, };
            var result8A = new MsScanMatchResult { AnnotatorID = "A", Source = (SourceType)2, Priority = 2, TotalScore = 20, };
            var result1B = new MsScanMatchResult { AnnotatorID = "B", Source = (SourceType)1, Priority = 1, TotalScore = 10, };
            var result2B = new MsScanMatchResult { AnnotatorID = "B", Source = (SourceType)1, Priority = 1, TotalScore = 20, };
            var result3B = new MsScanMatchResult { AnnotatorID = "B", Source = (SourceType)1, Priority = 2, TotalScore = 10, };
            var result4B = new MsScanMatchResult { AnnotatorID = "B", Source = (SourceType)1, Priority = 2, TotalScore = 20, };
            var result5B = new MsScanMatchResult { AnnotatorID = "B", Source = (SourceType)2, Priority = 1, TotalScore = 10, };
            var result6B = new MsScanMatchResult { AnnotatorID = "B", Source = (SourceType)2, Priority = 1, TotalScore = 20, };
            var result7B = new MsScanMatchResult { AnnotatorID = "B", Source = (SourceType)2, Priority = 2, TotalScore = 10, };
            var result8B = new MsScanMatchResult { AnnotatorID = "B", Source = (SourceType)2, Priority = 2, TotalScore = 20, };
