...
namespace CompMs.MsdialCore.DataObj.Tests
{
    ...
    public class MessagePackCompatibilityFixturesTests
    {
        ...
        [TestMethod]
        public void AnnotatedMsDecResultDeserializesLegacyBytes() {
            ...
            var actual = AnnotatedMSDecResult.Load(new MemoryStream(bytes));

            Assert.AreEqual(99.3, actual.QuantMass);
            Assert.IsNotNull(actual.Molecule);
            Assert.AreEqual("Meta", actual.Molecule.Name);
        }
