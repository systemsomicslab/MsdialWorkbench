    ...
    public class AnnotationQualitySearchQueryTests
    {
        ...
        public static IEnumerable<object[]> IsMatchedTestData {
            get {
                ...
                AnnotationQualitySearchQuery orSingle = AnnotationQualitySearchQuery.Or(AnnotationQualityType.LOW_QUALITY_SPECTRUM),
                    andSingle = AnnotationQualitySearchQuery.And(AnnotationQualityType.LOW_QUALITY_SPECTRUM),
                    or = AnnotationQualitySearchQuery.Or(AnnotationQualityType.LOW_QUALITY_SPECTRUM, AnnotationQualityType.MISANNOTATION),
                    and = AnnotationQualitySearchQuery.And(AnnotationQualityType.LOW_QUALITY_SPECTRUM, AnnotationQualityType.MISANNOTATION),
                    orEmpty = AnnotationQualitySearchQuery.Or(),
                    andEmpty = AnnotationQualitySearchQuery.And();
