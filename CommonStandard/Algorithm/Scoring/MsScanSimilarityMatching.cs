...
namespace CompMs.Common.Algorithm.Scoring {
    ...
    public sealed class MsScanSimilarityMatching {
        private MsScanSimilarityMatching() { }
        ...
        private static bool IsComparedAvailable(List<SpectrumPeak> obj1, List<SpectrumPeak> obj2) {
            if (obj1 == null || obj2 == null || obj1.Count == 0 || obj2.Count == 0) return false;
            return true;
        }
        ...
        /// </returns>
        public static double[] GetPresenceSimilarity(List<SpectrumPeak> peaks1, List<SpectrumPeak> peaks2, float bin,
