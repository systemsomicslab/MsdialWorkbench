    ...
    public class EtherPESpectrumGenerator : ILipidSpectrumGenerator
    {
        ...
        private SpectrumPeak[] GetEtherPESpectrum(ILipid lipid, AdductIon adduct)
        {
            ...
            if (adduct.AdductIonName == "[M+Na]+")
            {
                ...
                (
                     new[]
                     {
                        new SpectrumPeak(lipid.Mass - C2H8NO4P + MassDiffDictionary.ProtonMass, 150d, "Precursor -C2H8NO4P") { SpectrumComment = SpectrumComment.metaboliteclass },
                        ...
                        new SpectrumPeak(adduct.ConvertToMz(lipid.Mass - C2H5N - H2O + MassDiffDictionary.HydrogenMass), 500d, "Precursor -C2H6NO") { SpectrumComment = SpectrumComment.metaboliteclass },
                     }
                );
            }
            else
            {
                ...
                (
                     new[]
                     {
                        new SpectrumPeak(lipid.Mass - C2H8NO4P + MassDiffDictionary.ProtonMass, 500d, "Precursor -C2H8NO4P") { SpectrumComment = SpectrumComment.metaboliteclass },
                     }
                );
        ...
        private SpectrumPeak[] GetEtherPEPSpectrum(ILipid lipid, IChain alkylChain, IChain acylChain, AdductIon adduct)
        {
            var spectrum = new List<SpectrumPeak>
            {
                ...
                new SpectrumPeak(adduct.ConvertToMz(lipid.Mass - acylChain.Mass + MassDiffDictionary.HydrogenMass), 30d, $"-{acylChain}") { SpectrumComment = SpectrumComment.acylchain },
                ...
                new SpectrumPeak(adduct.ConvertToMz(lipid.Mass - acylChain.Mass  - MassDiffDictionary.OxygenMass-MassDiffDictionary.HydrogenMass), 30d, $"-{acylChain}-O") { SpectrumComment = SpectrumComment.acylchain },
            };
            if (adduct.AdductIonName == "[M+H]+")
            {
                ...
                (
                     new[]
                     {
                        new SpectrumPeak(alkylChain.Mass - MassDiffDictionary.HydrogenMass + C2H8NO4P + MassDiffDictionary.ProtonMass, 250d, "Sn1Ether+C2H8NO3P") { SpectrumComment = SpectrumComment.acylchain }, // Sn1 + O + C2H8NO3P
                        new SpectrumPeak(alkylChain.Mass - MassDiffDictionary.HydrogenMass + C2H8NO4P - H3PO4 + MassDiffDictionary.ProtonMass, 150d, "Sn1Ether+C2H8NO3P-H3PO4") { SpectrumComment = SpectrumComment.acylchain },
                        new SpectrumPeak(lipid.Mass - C2H8NO4P - alkylChain.Mass + MassDiffDictionary.HydrogenMass + MassDiffDictionary.ProtonMass, 300, "NL of C2H8NO4P+Sn1") { SpectrumComment = SpectrumComment.acylchain },
                     }
                );
            }
            return spectrum.ToArray();
        ...
        private SpectrumPeak[] GetAlkylPositionSpectrum(ILipid lipid, IChain alkylChain, AdductIon adduct)
        {
            return new[]
            {
                new SpectrumPeak(adduct.ConvertToMz(lipid.Mass - alkylChain.Mass - MassDiffDictionary.OxygenMass + MassDiffDictionary.HydrogenMass - CH2), 50d, "-CH2(Sn1)") { SpectrumComment = SpectrumComment.snposition },
            };
        }
