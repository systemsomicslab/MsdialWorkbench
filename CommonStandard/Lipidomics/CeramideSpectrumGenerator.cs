...
{
    public class CerNSSpectrumGenerator : ILipidSpectrumGenerator
    {
        public CerNSSpectrumGenerator(ISpectrumPeakGenerator spectrumGenerator)
        {
        ...
        {
            if (lipid.LipidClass == LbmClass.Cer_NS)
            {
