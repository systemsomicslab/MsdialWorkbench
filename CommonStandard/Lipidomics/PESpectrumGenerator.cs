    ...
    public class PESpectrumGenerator : ILipidSpectrumGenerator
    {
        ...
        public IMSScanProperty Generate(Lipid lipid, AdductIon adduct, IMoleculeProperty molecule = null)
        {
            ...
            if (lipid.Chains is MolecularSpeciesLevelChains mlChains)
            {
                ...
                spectrum.AddRange(GetAcylDoubleBondSpectrum(lipid, mlChains.Chains.OfType<AcylChain>(), adduct, nlMass: 141.1121));
            }
            if (lipid.Chains is PositionLevelChains plChains)
            {
                ...
                spectrum.AddRange(GetAcylDoubleBondSpectrum(lipid, plChains.Chains.OfType<AcylChain>(), adduct, nlMass: 141.1121));
            }
        ...
        private SpectrumPeak[] GetPESpectrum(ILipid lipid, AdductIon adduct)
        {
            var spectrum = new List<SpectrumPeak>
            {
                ...
                new SpectrumPeak(lipid.Mass - C2H8NO4P + adduct.AdductIonAccurateMass, 500d, "Precursor -C2H8NO4P"),
            ...
            if (adduct.AdductIonName == "[M+Na]+")
            {
                ...
                (
                     new[]
                     {
                        ...
                        new SpectrumPeak(lipid.Mass - CH5N + adduct.AdductIonAccurateMass, 200d, "Precursor -CH5N"),
                        new SpectrumPeak(lipid.Mass - CH5N -CH2 + adduct.AdductIonAccurateMass, 500d, "Precursor -CH5N -CH2")
                     }
                );
            }
        ...
        private SpectrumPeak[] GetAcylLevelSpectrum(ILipid lipid, IChain acylChain, AdductIon adduct)
        {
            ...
            var spectrum = new List<SpectrumPeak>
            {
                ...
                new SpectrumPeak(lipidMass - chainMass - MassDiffDictionary.OxygenMass - MassDiffDictionary.HydrogenMass, 100d, $"-{acylChain}-O"),
            };
            if (adduct.AdductIonName == "[M+H]+")
            {
                ...
                (
                     new[]
                     {
                        new SpectrumPeak(lipidMass - chainMass - C2H8NO4P , 100d, $"-Header -{acylChain}"),
                        new SpectrumPeak(lipidMass - chainMass - C2H8NO4P - H2O, 100d, $"-Header -{acylChain}-O"),
                     }
                );
            }
            return spectrum.ToArray();
        ...
        private SpectrumPeak[] GetAcylPositionSpectrum(ILipid lipid, IChain acylChain, AdductIon adduct)
        {
            ...
            if (adduct.AdductIonName == "[M+H]+")
            {
                ...
                (
                     new[]
                     {
                        new SpectrumPeak(lipidMass - chainMass - C2H8NO4P - MassDiffDictionary.OxygenMass - CH2, 100d, "-Header -CH2(Sn1)"),
                     }
                );
            }
            return spectrum.ToArray();
