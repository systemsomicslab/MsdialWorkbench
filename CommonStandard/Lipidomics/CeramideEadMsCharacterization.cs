...
{
    public static class CeramideEadMsCharacterization
    {
            ...
            float tolerance, float mzBegin, float mzEnd)
        {
            ...
            return EadMsCharacterizationUtility.GetDefaultCharacterizationResultForCeramides(molecule, defaultResult);
        }
    }
}
