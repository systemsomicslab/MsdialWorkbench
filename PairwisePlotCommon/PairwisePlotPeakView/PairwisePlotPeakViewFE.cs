...
namespace Rfx.Riken.OsakaUniv {
	public class PairwisePlotPeakViewFE : FrameworkElement
    {
        ...
        private void drawMS1DecResults()
        {
            ...
            for (int i = 0; i < this.pairwisePlotBean.Ms1DecResults.Count; i++)
            {
                    ...
                    && Math.Abs(this.yt - (this.ActualHeight - this.pairwisePlotPeakViewUI.CurrentMousePoint.Y)) < this.pairwisePlotPeakViewUI.PlotSize)
                {
					...
					formattedText = new FormattedText("Scan #: " + this.pairwisePlotBean.Ms1DecResults[i].ScanNumber + "; RT[min]: " + Math.Round(this.pairwisePlotBean.Ms1DecResults[i].RetentionTime, 3).ToString()
        ...
        {
            #region
            this.xt = this.pairwisePlotPeakViewUI.LeftMargin + (this.pairwisePlotBean.XAxisDatapointCollection[this.pairwisePlotBean.SelectedPlotId] - (double)this.pairwisePlotBean.DisplayRangeMinX) * this.xPacket;
            this.yt = this.pairwisePlotPeakViewUI.BottomMargin + (this.pairwisePlotBean.YAxisDatapointCollection[this.pairwisePlotBean.SelectedPlotId] - (double)this.pairwisePlotBean.DisplayRangeMinY) * this.yPacket;

            this.drawingContext.DrawLine(new Pen(Brushes.Red, 1.0), new Point(this.pairwisePlotPeakViewUI.LeftMargin, this.yt), new Point(this.ActualWidth - this.pairwisePlotPeakViewUI.RightMargin, this.yt));
            this.drawingContext.DrawLine(new Pen(Brushes.Red, 1.0), new Point(this.xt, this.pairwisePlotPeakViewUI.BottomMargin), new Point(this.xt, this.ActualHeight - this.pairwisePlotPeakViewUI.TopMargin));

            this.xs = this.pairwisePlotPeakViewUI.LeftMargin + (this.pairwisePlotBean.RectangleRangeXmin - (double)this.pairwisePlotBean.DisplayRangeMinX) * this.xPacket;
            this.xe = this.pairwisePlotPeakViewUI.LeftMargin + (this.pairwisePlotBean.RectangleRangeXmax - (double)this.pairwisePlotBean.DisplayRangeMinX) * this.xPacket;
            this.ys = this.pairwisePlotPeakViewUI.BottomMargin + (this.pairwisePlotBean.RectangleRangeYmin - (double)this.pairwisePlotBean.DisplayRangeMinY) * this.yPacket;
            this.ye = this.pairwisePlotPeakViewUI.BottomMargin + (this.pairwisePlotBean.RectangleRangeYmax - (double)this.pairwisePlotBean.DisplayRangeMinY) * this.yPacket;
            ...
            if (this.pairwisePlotBean.PeakAreaBeanCollection[this.pairwisePlotBean.SelectedPlotId].IsotopeWeightNumber != 0
                && this.pairwisePlotBean.PeakAreaBeanCollection[this.pairwisePlotBean.SelectedPlotId].IsotopeParentPeakID > 0)
            {
                this.xs = this.pairwisePlotPeakViewUI.LeftMargin + (this.pairwisePlotBean.XAxisDatapointCollection[this.pairwisePlotBean.SelectedPlotId] - (double)this.pairwisePlotBean.DisplayRangeMinX) * this.xPacket;
                this.xe = this.pairwisePlotPeakViewUI.LeftMargin + (this.pairwisePlotBean.XAxisDatapointCollection[this.pairwisePlotBean.PeakAreaBeanCollection[this.pairwisePlotBean.SelectedPlotId].IsotopeParentPeakID] - (double)this.pairwisePlotBean.DisplayRangeMinX) * this.xPacket;
                this.ys = this.pairwisePlotPeakViewUI.BottomMargin + (this.pairwisePlotBean.YAxisDatapointCollection[this.pairwisePlotBean.SelectedPlotId] - (double)this.pairwisePlotBean.DisplayRangeMinY) * this.yPacket;
                this.ye = this.pairwisePlotPeakViewUI.BottomMargin + (this.pairwisePlotBean.YAxisDatapointCollection[this.pairwisePlotBean.PeakAreaBeanCollection[this.pairwisePlotBean.SelectedPlotId].IsotopeParentPeakID] - (double)this.pairwisePlotBean.DisplayRangeMinY) * this.yPacket;

                if (Math.Abs(this.ye - this.ys) >= 20)
                {
                    this.drawingContext.DrawLine(new Pen(Brushes.Orange, 1), new Point(this.xs + 20 + (this.xe - this.xs), this.ys - 10), new Point(this.xe + 20, this.ye + 10));
                    this.drawingContext.DrawLine(new Pen(Brushes.Orange, 1), new Point(this.xs, this.ys), new Point(this.xs + 20 + (this.xe - this.xs), this.ys - 10));
                    this.drawingContext.DrawLine(new Pen(Brushes.Orange, 1), new Point(this.xe, this.ye), new Point(this.xe + 20, this.ye + 10));
                    this.drawingContext.DrawLine(new Pen(Brushes.Orange, 1), new Point(this.xe, this.ye), new Point(this.xe + 3, this.ye + 7));
                    this.drawingContext.DrawLine(new Pen(Brushes.Orange, 1), new Point(this.xe, this.ye), new Point(this.xe + 7, this.ye - 3));
                }
            }
            ...
            if (this.pairwisePlotBean.PeakAreaBeanCollection[this.pairwisePlotBean.SelectedPlotId].AdductIonName != string.Empty
                ...
                && this.pairwisePlotBean.PeakAreaBeanCollection[this.pairwisePlotBean.SelectedPlotId].AdductParent != this.pairwisePlotBean.PeakAreaBeanCollection[this.pairwisePlotBean.SelectedPlotId].PeakID
                && this.pairwisePlotBean.PeakAreaBeanCollection[this.pairwisePlotBean.SelectedPlotId].IsotopeWeightNumber == 0)
            {
                this.xs = this.pairwisePlotPeakViewUI.LeftMargin + (this.pairwisePlotBean.XAxisDatapointCollection[this.pairwisePlotBean.SelectedPlotId] - (double)this.pairwisePlotBean.DisplayRangeMinX) * this.xPacket;
                this.xe = this.pairwisePlotPeakViewUI.LeftMargin + (this.pairwisePlotBean.XAxisDatapointCollection[this.pairwisePlotBean.PeakAreaBeanCollection[this.pairwisePlotBean.SelectedPlotId].AdductParent] - (double)this.pairwisePlotBean.DisplayRangeMinX) * this.xPacket;
                this.ys = this.pairwisePlotPeakViewUI.BottomMargin + (this.pairwisePlotBean.YAxisDatapointCollection[this.pairwisePlotBean.SelectedPlotId] - (double)this.pairwisePlotBean.DisplayRangeMinY) * this.yPacket;
                this.ye = this.pairwisePlotPeakViewUI.BottomMargin + (this.pairwisePlotBean.YAxisDatapointCollection[this.pairwisePlotBean.PeakAreaBeanCollection[this.pairwisePlotBean.SelectedPlotId].AdductParent] - (double)this.pairwisePlotBean.DisplayRangeMinY) * this.yPacket;

                if (Math.Abs(this.ye - this.ys) >= 20)
                {
                    this.drawingContext.DrawLine(new Pen(Brushes.Orange, 1), new Point(this.xs - 20 - (this.xs - this.xe), this.ys - 10), new Point(this.xe - 20, this.ye + 10));
                    this.drawingContext.DrawLine(new Pen(Brushes.Orange, 1), new Point(this.xs, this.ys), new Point(this.xs - 20 - (this.xs - this.xe), this.ys - 10));
                    this.drawingContext.DrawLine(new Pen(Brushes.Orange, 1), new Point(this.xe, this.ye), new Point(this.xe - 20, this.ye + 10));
                    this.drawingContext.DrawLine(new Pen(Brushes.Orange, 1), new Point(this.xe, this.ye), new Point(this.xe - 3, this.ye + 7));
                    this.drawingContext.DrawLine(new Pen(Brushes.Orange, 1), new Point(this.xe, this.ye), new Point(this.xe - 7, this.ye - 3));
                }
        ...
        private void drawPairwisePlots()
        {
            for (int i = 0; i < this.pairwisePlotBean.XAxisDatapointCollection.Count; i++)
            {
                    ...
                    && Math.Abs(this.yt - (this.ActualHeight - this.pairwisePlotPeakViewUI.CurrentMousePoint.Y)) < this.pairwisePlotPeakViewUI.PlotSize)
                {
                    ...
                    formattedText = new FormattedText("Scan #: " + this.pairwisePlotBean.PeakAreaBeanCollection[i].ScanNumberAtPeakTop + "; RT[min]: " + Math.Round(this.pairwisePlotBean.XAxisDatapointCollection[i], 3).ToString() +
        ...
        private bool peakAreaBeanDisplayFilter(PairwisePlotBean plot, int i)
        {
            ...
            if (plot.Ms1DecResults == null || plot.Ms1DecResults.Count == 0)
            {
                ...
                {
                    if (plot.PeakAreaBeanCollection[i].MetaboliteName.IndexOf("w/o MS2:", 0) < 0) return false;
                }
                else if (plot.IdentifiedOnlyDisplayFilter)
                {
                    if (plot.PeakAreaBeanCollection[i].MetaboliteName == string.Empty || this.pairwisePlotBean.PeakAreaBeanCollection[i].MetaboliteName.IndexOf("w/o MS2:", 0) >= 0) return false;
                }
                else if (plot.UnknownFilter)
                {
            ...
            else
            {
                for (int i = 0; i < this.pairwisePlotBean.XAxisDatapointCollection.Count; i++)
                {
                    ...
                    if (this.pairwisePlotBean.Ms1DecResults == null || this.pairwisePlotBean.Ms1DecResults.Count == 0)
                    {
                        if (this.pairwisePlotBean.AnnotatedOnlyDisplayFilter && this.pairwisePlotBean.IdentifiedOnlyDisplayFilter)
                        {
                            if (this.pairwisePlotBean.PeakAreaBeanCollection[i].MetaboliteName == string.Empty) continue;
                        }
                        else if (this.pairwisePlotBean.AnnotatedOnlyDisplayFilter)
                        {
                            if (this.pairwisePlotBean.PeakAreaBeanCollection[i].MetaboliteName.IndexOf("w/o MS2:", 0) < 0) continue;
                        }
                        else if (this.pairwisePlotBean.IdentifiedOnlyDisplayFilter)
                        {
                            if (this.pairwisePlotBean.PeakAreaBeanCollection[i].MetaboliteName == string.Empty || this.pairwisePlotBean.PeakAreaBeanCollection[i].MetaboliteName.IndexOf("w/o MS2:", 0) >= 0) continue;
                        }
                        else if (this.pairwisePlotBean.UnknownFilter)
                        {
                            if (this.pairwisePlotBean.PeakAreaBeanCollection[i].LibraryID >= 0 || this.pairwisePlotBean.PeakAreaBeanCollection[i].PostIdentificationLibraryId >= 0) continue;
                        }
                    }

                    if (this.pairwisePlotBean.MsmsOnlyDisplayFilter && this.pairwisePlotBean.PeakAreaBeanCollection[i].Ms2LevelDatapointNumber < 0) continue;
