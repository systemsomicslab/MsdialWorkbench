...
namespace CompMs.MspGenerator
{
    public sealed class SmilesLipidHeader
    {
        ...
        public static Dictionary<string, string> HeaderDictionary = new Dictionary<string, string>()
        {
            ...
            {"GQ1b", "CC(O)=NC1C(O)CC(OC(CO)C(O)C2OC(CC(O)C2N=C(C)O)(OC2C(O)C(CO)OC(OC3C(O)C(CO)OC(OC4C(CO)OC(OC5C(O)C(O)C(OCCC%20N%30)OC5CO)C(O)C4OC4(CC(O)C(N=C(C)O)C(O4)C(O)C(CO)OC4(CC(O)C(N=C(C)O)C(O4)C(O)C(O)CO)C(O)=O)C(O)=O)C3N=C(C)O)C2O)C(O)=O)(OC1C(O)C(O)CO)C(O)=O."},
