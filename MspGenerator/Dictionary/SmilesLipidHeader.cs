...
namespace CompMs.MspGenerator
{
    public sealed class SmilesLipidHeader
    {
        ...
        public static Dictionary<string, string> HeaderDictionary = new Dictionary<string, string>()
        {
            ...
            {"GD1a", "CC(=O)NC1C(O)CC(OC2C(O)C(O)C(OC3C(O)C(CO)OC(OC4C(CO)OC(OC5C(O)C(O)C(OCC%20N%30)OC5CO)C(O)C4OC4(CC(O)C(NC(C)=O)C(O4)C(O)C(O)CO)C([O-])=O)C3NC(C)=O)OC2CO)(OC1C(O)C(O)CO)C(O)=O."},
            {"GD1b", "CC(=O)NC1C(O)CC(OC2C(O)C(OC3C(O)C(O)C(OCC%20N%30)OC3CO)OC(CO)C2OC2OC(CO)C(O)C(OC3OC(CO)C(O)C(O)C3O)C2NC(C)=O)(OC1C(O)C(CO)OC1(CC(O)C(NC(=O)CO)C(O1)C(O)C(O)CO)C(O)=O)C(O)=O."},
