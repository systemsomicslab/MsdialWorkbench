...
namespace CompMs.Common.Lipidomics.Tests
{
    ...
    public class OadSpectrumPeakGeneratorTests
    {
        ...
        public void OadSpectrumPeakGeneratorTest()
        {
            ...
            {
                new SpectrumPeak(689.4626f,10f),
                new SpectrumPeak(690.4704f,10f),
                new SpectrumPeak(691.4782f,10f),
                new SpectrumPeak(671.452f,10f),
                new SpectrumPeak(672.4599f,10f),
                new SpectrumPeak(647.452f,10f),
            ...
            expected = new SpectrumPeak[]
            {
                ...
                new SpectrumPeak(667.4212f,10f),
                new SpectrumPeak(668.4291f,10f),
                ...
                new SpectrumPeak(707.4528f,10f),
                new SpectrumPeak(708.4607f,10f),
                ...
                new SpectrumPeak(747.4825f,10f),
                new SpectrumPeak(748.4904f,10f),
            ...
            expected = new SpectrumPeak[]
            {
                ...
                new SpectrumPeak(657.4727f,10f),
                new SpectrumPeak(658.4806f,10f),
        ...
        public void OadSphingoSpectrumPeakGeneratorTest()
        {
            ...
            var expected = new SpectrumPeak[]
            {
                ...
                new SpectrumPeak(614.4418f,10f),
                new SpectrumPeak(615.4497f,10f),
