...
namespace CompMs.Common.Lipidomics.Tests
{
    ...
    public class OxidizedTests
    {
        ...
        public static IEnumerable<object[]> OxidizedTestData() {
            ...
            yield return new object[] { ((IVisitableElement<IOxidized>)new Oxidized(2)).Accept(visitor, decomposer), 2, 0, 2, ";2O", };
            yield return new object[] { ((IVisitableElement<IOxidized>)new Oxidized(2, 1, 3)).Accept(visitor, decomposer), 2, 0, 2, ";2O", };
        }
    }
}