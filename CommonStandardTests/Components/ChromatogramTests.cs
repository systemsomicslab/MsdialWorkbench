...
namespace CompMs.Common.Components.Tests
{
    ...
    public class ChromatogramTests
    {
        ...
        public void SmoothingSimpleTest() {
            var rawdata = new[]
            {
                new ChromatogramPeak(0, 0, 0, 100d, 1000d, new RetentionTime(0d)),
                new ChromatogramPeak(1, 1, 1, 101d, 1001d, new RetentionTime(1d)),
                new ChromatogramPeak(2, 2, 2, 102d, 1002d, new RetentionTime(2d)),
                new ChromatogramPeak(3, 3, 3, 103d, 1003d, new RetentionTime(3d)),
                new ChromatogramPeak(4, 4, 4, 104d, 1004d, new RetentionTime(4d)),
                new ChromatogramPeak(5, 5, 5, 105d, 1005d, new RetentionTime(5d)),
                new ChromatogramPeak(6, 6, 6, 106d, 1006d, new RetentionTime(6d)),
                new ChromatogramPeak(7, 7, 7, 107d, 1007d, new RetentionTime(7d)),
                new ChromatogramPeak(8, 8, 8, 108d, 1008d, new RetentionTime(8d)),
                new ChromatogramPeak(9, 9, 9, 109d, 1009d, new RetentionTime(9d)),
            };
