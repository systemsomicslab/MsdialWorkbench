...
TG 15:0_18:1_15:0(d7)	829.79854	14.45	[M+NH4]+	YUNYDLOKHYJQAT-OTEPLKBXSA-N	C51H89D7O6	C(OC(=O)CCCCCCCCCCCCCC)[C@](OC(CCCCCCC/C=C\CCCCCC([2H])([2H])C([2H])([2H])C([2H])([2H])[2H])=O)COC(CCCCCCCCCCCCCC)=O	TG	310.2784
...
Cer 18:1;2O/15:0(d7)	531.5476588	9.34	[M+H]+	HBULQAPKKLNTLT-BXLQGFJZSA-N	C33H58D7NO3	[H][C@@](O)(\C=C\CCCCCCCCCCCCC)[C@]([H])(CO)NC(=O)CCCCCCCCCCCC([2H])([2H])C([2H])([2H])C([2H])([2H])[2H]	Cer-NS	254.166";
        ...
        public void TestLibraryReaderNoOptionFieldTest()
        {
            string no_option_data = string.Join("\r\n", new string[]
            {
                ...
                "TG 15:0_18:1_15:0(d7)\t829.79854",
