    ...
    public class LcimmsTextDBAnnotatorTests
    {
        ...
        public void CalculateScoreTest() {
            var reference = new MoleculeMsReference {
                ...
                {
                    new SpectrumPeak { Mass = 184.073f, Intensity = 100f },
                    new SpectrumPeak { Mass = 506.361f, Intensity = 5f },
                    new SpectrumPeak { Mass = 524.372f, Intensity = 5f },
                    new SpectrumPeak { Mass = 526.330f, Intensity = 5f },
                    new SpectrumPeak { Mass = 544.340f, Intensity = 5f },
                    new SpectrumPeak { Mass = 810.601f, Intensity = 30f },
                }
            };
            var parameter = new MsRefSearchParameterBase
            {
            ...
            {
                new SpectrumPeak { Mass = 86.094f, Intensity = 5f, },
                new SpectrumPeak { Mass = 184.073f, Intensity = 100f, },
                new SpectrumPeak { Mass = 524.367f, Intensity = 1f, },
                new SpectrumPeak { Mass = 810.604f, Intensity = 25f, },
            };
        ...
        public void SelectTopHitTest() {
            var annotator = new LcimmsTextDBAnnotator(new MoleculeDataBase(Enumerable.Empty<MoleculeMsReference>(), "TextDB", DataBaseSource.Text, SourceType.TextDB), new MsRefSearchParameterBase(), "TextDB", -1);
