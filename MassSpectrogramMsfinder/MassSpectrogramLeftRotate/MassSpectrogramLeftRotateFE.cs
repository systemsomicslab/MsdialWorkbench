...
namespace Rfx.Riken.OsakaUniv
{
    public class MassSpectrogramLeftRotateFE : FrameworkElement
    {
        ...
        {
            if (this.massSpectrogramViewModel == null)
                this.formattedText = new FormattedText("MS1 chromatogram", CultureInfo.GetCultureInfo("en-us"), FlowDirection.LeftToRight, new Typeface("Calibri"), 15, Brushes.Black);
            else
