...
{
    public class ChromatogramXicViewModel
    {
        ...
        private ChromatogramBean chromatogramBean;
        ...
        public ChromatogramXicViewModel(ChromatogramBean chromatogramBean, ChromatogramEditMode editMode, ChromatogramDisplayLabel displayLabel, ChromatogramQuantitativeMode quantitativeMode,
        ...
        public ChromatogramXicViewModel(ChromatogramBean chromatogramBean, ChromatogramEditMode editMode, ChromatogramDisplayLabel displayLabel, 
        ...
        public void setInitialValuesByChromatogramBeanCollection(ChromatogramBean chromatogram, float targetRT, bool scaledToFocus)
        {
            ...
            if (scaledToFocus == true) { // chromatogram is scaled by its focused intensity
                ...
                for (int i = 0; i < chromatogram.ChromatogramDataPointCollection.Count; i++) { // determine the target place
                    var rt = chromatogram.ChromatogramDataPointCollection[i][1];
                ...
                if (minID < 0) return;
                this.displayRangeIntensityMax = (float)chromatogram.ChromatogramDataPointCollection[minID][3];
            }
        }
        ...
        public ChromatogramBean ChromatogramBean
        {
