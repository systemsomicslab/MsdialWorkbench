...
namespace Rfx.Riken.OsakaUniv.ManualPeakMod
{
    public class PeakModFE : FrameworkElement
    {
        ...
        public PeakModFE(DrawVisualManualPeakModification drawing, PeakModUC uc) {
            this.uc = uc;
        ...
        public PeakModFE(DrawVisualManualPeakModification drawing) {
            visualCollection = new VisualCollection(this);
            this.drawing = drawing;
        }
        ...
        public void ZoomRubberDraw() {
            ...
            Debug.WriteLine("start x {0}, start y {1}, end x {2}, end y {3}",
                this.uc.RightButtonStartClickPoint.X, this.uc.RightButtonStartClickPoint.Y,
                this.uc.RightButtonEndClickPoint.X, this.uc.RightButtonEndClickPoint.Y);
        }
