...
namespace StructureFinderConsoleApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Code4CASMI.SeparatedLibraryCreator4Metfrag(
            //    @"E:\6_Projects\PROJECT_CompMsToolsMetaAnalysis\library_creation_20240510\queryfile.txt",
            //    @"E:\6_Projects\PROJECT_CompMsToolsMetaAnalysis\library_creation_20240510\metfraglibrary.txt",
            //    @"E:\6_Projects\PROJECT_CompMsToolsMetaAnalysis\library_creation_20240510\metfrag");

            Code4CASMI.SeparatedLibraryCreator4Cfmid(
                @"E:\6_Projects\PROJECT_CompMsToolsMetaAnalysis\library_creation_20240510\queryfile.txt",
                @"E:\6_Projects\PROJECT_CompMsToolsMetaAnalysis\library_creation_20240510\cfmlibrary.txt",
                @"E:\6_Projects\PROJECT_CompMsToolsMetaAnalysis\library_creation_20240510\cfmid");
