...
{
    //cite: ftp://ftp.ncbi.nlm.nih.gov/pubchem/specifications/pubchem_fingerprints.txt
    //original pubchem fingerprinter is optimized for mass spec informatics
    ...
    public sealed class PubChemFingerprint
    {
        ...
        private static void setMolecularDescriptorOfSection2(MolecularDescriptorRingBasis descriptor, RingProperty ringProp)
        {
            ...
            if (ringProp.ConnectedAtoms.Count >= 3) { //ring size >= 3
                descriptor.Bit40 += 1;  //>= 1 any ring size 3

                if (ringProp.RingEnv.DoublebondInRing == 0 || ringProp.IsAromaticRing) { //saturated or aromatic
            ...
            if (ringProp.ConnectedAtoms.Count >= 4) { //ring size >= 4
            ...
            if (ringProp.ConnectedAtoms.Count >= 5) { //ring size >= 5
            ...
            if (ringProp.ConnectedAtoms.Count >= 6) { //ring size >= 6
            ...
            if (ringProp.ConnectedAtoms.Count >= 7) { //ring size >= 7
            ...
            if (ringProp.ConnectedAtoms.Count >= 8) { //ring size >= 8
            ...
            if (ringProp.ConnectedAtoms.Count >= 9) { //ring size >= 9
            ...
            if (ringProp.ConnectedAtoms.Count >= 10) { //ring size >= 10
