...
namespace Riken.Metabolomics.StructureFinder.Result
{
    public class FragmenterResult
    {
        ...
        private List<Peak> referenceSpectrum;
        ...
        public FragmenterResult(MspFormatCompoundInformationBean mspRecord, string metaboliteName)
        {
            this.isSpectrumSearchResult = true;
            this.fragmentPics = null;
            this.referenceSpectrum = new List<Peak>();
            foreach (var spec in mspRecord.MzIntensityCommentBeanList) {
                this.referenceSpectrum.Add(new Peak() { Mz = spec.Mz, Intensity = spec.Intensity, Comment = spec.Comment });
            }
        ...
        public FragmenterResult(bool isSpectrumSearchResult, List<PeakFragmentPair> fragmentPics, List<Peak> referenceSpectrum,
        ...
        public List<Peak> ReferenceSpectrum
        {
