...
namespace Rfx.Riken.OsakaUniv
{
    public sealed class SevenGoldenRulesCheck
    {
        ...
        public static List<IsotopicPeak> GetIsotopicPeaks(Formula formula)
        {
            ...
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Cnum * c13_c12, Mass = formula.Mass + c13_c12_MassDiff, Comment = "13C" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Hnum * h2_h1, Mass = formula.Mass + h2_h1_MassDiff, Comment = "2H" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Nnum * n15_n14, Mass = formula.Mass + n15_n14_MassDiff, Comment = "15N" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Onum * o17_o16, Mass = formula.Mass + o17_o16_MassDiff, Comment = "17O" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Snum * s33_s32, Mass = formula.Mass + s33_s32_MassDiff, Comment = "33S" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Sinum * si29_si28, Mass = formula.Mass + si29_si28_MassDiff, Comment = "29Si" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Cnum * c13_c12 * formula.Hnum * h2_h1, Mass = formula.Mass + c13_c12_MassDiff + h2_h1_MassDiff, Comment = "2H,13C" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Cnum * c13_c12 * formula.Nnum * n15_n14, Mass = formula.Mass + c13_c12_MassDiff + n15_n14_MassDiff, Comment = "13C,15N" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Cnum * c13_c12 * formula.Onum * o17_o16, Mass = formula.Mass + c13_c12_MassDiff + o17_o16_MassDiff, Comment = "13C,17O" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Cnum * c13_c12 * formula.Snum * s33_s32, Mass = formula.Mass + c13_c12_MassDiff + s33_s32_MassDiff, Comment = "13C,33S" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Cnum * c13_c12 * formula.Sinum * si29_si28, Mass = formula.Mass + c13_c12_MassDiff + si29_si28_MassDiff, Comment = "13C,29Si" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Hnum * h2_h1 * formula.Nnum * n15_n14, Mass = formula.Mass + h2_h1_MassDiff + n15_n14_MassDiff, Comment = "2H,15N" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Hnum * h2_h1 * formula.Onum * o17_o16, Mass = formula.Mass + h2_h1_MassDiff + o17_o16_MassDiff, Comment = "2H,17O" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Hnum * h2_h1 * formula.Snum * s33_s32, Mass = formula.Mass + h2_h1_MassDiff + s33_s32_MassDiff, Comment = "2H,33S" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Hnum * h2_h1 * formula.Sinum * si29_si28, Mass = formula.Mass + h2_h1_MassDiff + si29_si28_MassDiff, Comment = "2H,29Si" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Nnum * n15_n14 * formula.Onum * o17_o16, Mass = formula.Mass + n15_n14_MassDiff + o17_o16_MassDiff, Comment = "15N,17O" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Nnum * n15_n14 * formula.Snum * s33_s32, Mass = formula.Mass + n15_n14_MassDiff + s33_s32_MassDiff, Comment = "15N,33S" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Nnum * n15_n14 * formula.Sinum * si29_si28, Mass = formula.Mass + n15_n14_MassDiff + si29_si28_MassDiff, Comment = "15N,29Si" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Onum * o17_o16 * formula.Snum * s33_s32, Mass = formula.Mass + o17_o16_MassDiff + s33_s32_MassDiff, Comment = "17O,33S" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Onum * o17_o16 * formula.Sinum * si29_si28, Mass = formula.Mass + o17_o16_MassDiff + si29_si28_MassDiff, Comment = "17O,29Si" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Snum * s33_s32 * formula.Sinum * si29_si28, Mass = formula.Mass + s33_s32_MassDiff + si29_si28_MassDiff, Comment = "29Si,33S" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Cnum * (formula.Cnum - 1) * 0.5 * Math.Pow(c13_c12, 2), Mass = formula.Mass + c13_c12_MassDiff * 2.0, Comment = "13C,13C" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Hnum * (formula.Hnum - 1) * 0.5 * Math.Pow(h2_h1, 2), Mass = formula.Mass + h2_h1_MassDiff * 2.0, Comment = "2H,2H" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Nnum * (formula.Nnum - 1) * 0.5 * Math.Pow(n15_n14, 2), Mass = formula.Mass + n15_n14_MassDiff * 2.0, Comment = "15N,15N" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Onum * (formula.Onum - 1) * 0.5 * Math.Pow(o17_o16, 2), Mass = formula.Mass + o17_o16_MassDiff * 2.0, Comment = "17O,17O" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Snum * (formula.Snum - 1) * 0.5 * Math.Pow(s33_s32, 2), Mass = formula.Mass + s33_s32_MassDiff * 2.0, Comment = "33S,33S" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Sinum * (formula.Sinum - 1) * 0.5 * Math.Pow(si29_si28, 2), Mass = formula.Mass + si29_si28_MassDiff * 2.0, Comment = "29Si,29Si" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Onum * o18_o16, Mass = formula.Mass + o18_o16_MassDiff, Comment = "18O" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Snum * s34_s32, Mass = formula.Mass + s34_s32_MassDiff, Comment = "34S" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Sinum * si30_si28, Mass = formula.Mass + si30_si28_MassDiff, Comment = "30Si" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Brnum * br81_br79, Mass = formula.Mass + br81_br79_MassDiff, Comment = "81Br" });
            isotopicPeaks.Add(new IsotopicPeak() { RelativeAbundance = formula.Clnum * cl37_cl35, Mass = formula.Mass + cl37_cl35_MassDiff, Comment = "37Cl" });
