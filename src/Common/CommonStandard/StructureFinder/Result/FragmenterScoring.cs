...
namespace CompMs.Common.StructureFinder.Result
{
    public sealed class FragmenterScoring
    {
        ...
        public static double RetentionTimeSimilairty(RawData rawdata,
            MspRecord mspRecord, AnalysisParamOfMsfinder param)
        {
        ...
        public static double PredictRetentionTime(Structure structure, AnalysisParamOfMsfinder param)
        {
        ...
        public static double CollisionCrossSection(RawData rawdata, Structure structure, AnalysisParamOfMsfinder param)
        {
        ...
        public static double CalculateRtSimilarity(RawData rawdata, Structure structure, AnalysisParamOfMsfinder param)
        {
            if (!param.IsUsePredictedRtForStructureElucidation) return -1.0;
            if (param.IsUseXlogpPrediction)
            {
        ...
        public static double CalculateCcsSimilarity(RawData rawdata,
