...
namespace CompMs.Common.StructureFinder
{
    public sealed class MainProcess
    {
        ...
        /// </summary>
        public static List<FragmenterResult> Fragmenter(string sdfFile, RawData rawdata, List<SpectrumPeak> curatedPeaks,
            List<SpectrumPeak> originalPeaks, AdductIon adduct,
        ...
        /// </summary>
        public static List<FragmenterResult> Fragmenter(List<ExistStructureQuery> queries, RawData rawdata,
            List<SpectrumPeak> curatedPeaks, List<SpectrumPeak> originalPeaks, AdductIon adduct,
        ...
        public static List<FragmenterResult> FragmenterResults(List<Property.Structure> structures, RawData rawdata, List<SpectrumPeak> curatedPeaks, List<SpectrumPeak> originalPeaks,
        ...
        public static FragmenterResult GetFragmenterResult(Property.Structure structure, RawData rawdata, List<SpectrumPeak> curatedPeaks, List<SpectrumPeak> originalPeaks,
            AdductIon adduct, FormulaResult formulaResult, AnalysisParamOfMsfinder param,
            List<FragmentLibrary> fragmentDB, List<FragmentOntology> fragmentOntologies)
        {
            FragmenterResult fragmenterResult = null;

            var referenceRt = FragmenterScoring.PredictRetentionTime(structure, param);
            ...
            {
                var fragments = FragmentGenerator.GetFragmentCandidates(structure, param.TreeDepth, curatedPeaks.Min(n => n.Mass));
