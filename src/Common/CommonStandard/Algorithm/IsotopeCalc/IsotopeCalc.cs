...
namespace CompMs.Common.Algorithm.IsotopeCalc {
    ...
    public static  class IsotopeCalculator {
        ...
        public static List<AtomProperty> GetBasicCompoundElementProfile(string formula) {
            List<AtomProperty> elementProfileList = new List<AtomProperty>();
            AtomProperty elementPropertyBean = new AtomProperty();
            MatchCollection mc;
        ...
        private static void setIupacReferenceInformation(IsotopeProperty compoundPropertyBean, IupacDatabase iupacReferenceBean) {
            double accurateMass = 0; ;
            for (int i = 0; i < compoundPropertyBean.ElementProfile.Count; i++) {
                if (iupacReferenceBean.ElementName2AtomElementProperties.ContainsKey(compoundPropertyBean.ElementProfile[i].ElementName)) {
        ...
        private static void setAccurateIsotopePropertyInformation(IsotopeProperty compoundPropertyBean, int massFilter) {
            for (int i = 0; i < compoundPropertyBean.ElementProfile.Count; i++) {
                ...
                compoundPropertyBean.ElementProfile[i].IsotopicPeaks = compoundPropertyBean.ElementProfile[i].IsotopicPeaks.OrderBy(n => n.MassDifferenceFromMonoisotopicIon).ToList();
            }
        }

        private static void setFinalAccurateIsotopeProfile(IsotopeProperty compoundPropertyBean, int massFilter) {
        ...
        private static void setNominalIsotopePropertyInformation(IsotopeProperty compoundPropertyBean, int massFilter) {
            for (int i = 0; i < compoundPropertyBean.ElementProfile.Count; i++) {
                compoundPropertyBean.ElementProfile[i].IsotopicPeaks = getIsotopeElementProperty(compoundPropertyBean.ElementProfile[i].AtomElementProperties);
        ...
        private static void setFinalNominalIsotopeProfile(IsotopeProperty compoundPropertyBean, int massFilter) {
            List<IsotopicPeak> abundanceElementPropertyBean = new List<IsotopicPeak>();
            abundanceElementPropertyBean = compoundPropertyBean.ElementProfile[0].IsotopicPeaks;
        ...
        private static List<IsotopicPeak> getIsotopeElementProperty(List<AtomElementProperty> iupacElementPropertyBeanList) {
