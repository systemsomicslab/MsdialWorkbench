...
{
    public static class LDGTAEadMsCharacterization
    {
            ...
            float tolerance, float mzBegin, float mzEnd)
        {
            ...
            if (CompairTwoFeagmentsIntensity.isFragment1GreaterThanFragment2(exp_spectrum, tolerance, LdgtsFrag + adduct, LdgtaFrag + adduct)) //reject LDGTA
            {
                class_cutoff = 10;
            }
