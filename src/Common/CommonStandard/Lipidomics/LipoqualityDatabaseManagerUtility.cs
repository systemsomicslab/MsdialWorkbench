...
namespace CompMs.Common.Lipidomics {
    public sealed class LipoqualityDatabaseManagerUtility
    {
        ...
        public static LipoqualityAnnotation ConvertMsdialLipidnameToLipidAnnotation(MoleculeMsReference query, string metaboliteName)
        {
        ...
        private static void setSingleAcylChainsLipidAnnotation(LipoqualityAnnotation lipidannotation,
            MoleculeMsReference query, string metabolitename) {
