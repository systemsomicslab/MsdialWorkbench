    ...
    public class PSEidSpectrumGenerator : ILipidSpectrumGenerator
    {
        ...
        public IMSScanProperty Generate(Lipid lipid, AdductIon adduct, IMoleculeProperty molecule = null)
        {
            ...
            if (lipid.Chains is MolecularSpeciesLevelChains mlChains)
            {
                ...
                spectrum.AddRange(GetAcylDoubleBondSpectrum(lipid, mlChains.GetChains().OfType<AcylChain>(), adduct, nlMass: C3H8NO6P));
            ...
            if (lipid.Chains is PositionLevelChains plChains)
            {
                ...
                spectrum.AddRange(GetAcylDoubleBondSpectrum(lipid, plChains.GetChains().OfType<AcylChain>(), adduct, nlMass: C3H8NO6P));
                spectrum.AddRange(EidSpecificSpectrum(lipid, adduct, nlMass: C3H8NO6P, 200d));
            }
