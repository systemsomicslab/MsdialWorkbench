...
{
    public class PIOadSpectrumGenerator : ILipidSpectrumGenerator
    {
        ...
        public PIOadSpectrumGenerator()
        {
            spectrumGenerator = new OadSpectrumPeakGenerator();
        }

        public PIOadSpectrumGenerator(IOadSpectrumPeakGenerator spectrumGenerator)
        {
        ...
        private SpectrumPeak[] GetPIOadSpectrum(Lipid lipid, AdductIon adduct, double nlMass)
        {
            var spectrum = new List<SpectrumPeak>();
