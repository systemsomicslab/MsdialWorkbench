...
{
    public static class DGTSEadMsCharacterization
    {
            ...
            float tolerance, float mzBegin, float mzEnd)
        {
            ...
            if (CompairTwoFeagmentsIntensity.isFragment1GreaterThanFragment2(exp_spectrum, tolerance, DgtaFrag + adduct, DgtsFrag + adduct))
            {
                class_cutoff = 10;
            }
