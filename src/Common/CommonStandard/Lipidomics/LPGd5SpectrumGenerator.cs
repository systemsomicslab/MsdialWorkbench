...
{
    public class LPGd5SpectrumGenerator : ILipidSpectrumGenerator
    {
        ...
        public LPGd5SpectrumGenerator()
        {
            spectrumGenerator = new SpectrumPeakGenerator();
        }

        public LPGd5SpectrumGenerator(ISpectrumPeakGenerator peakGenerator)
        {
        ...
        {
            if (lipid.LipidClass == LbmClass.LPG_d5)
            {
        ...
        {
            var nlMass = adduct.AdductIonName == "[M+NH4]+" ? adduct.AdductIonAccurateMass - MassDiffDictionary.ProtonMass : 0.0;
        ...
        private SpectrumPeak[] GetAcylPositionSpectrum(ILipid lipid, IChain acylChain, AdductIon adduct)
        {
            ...
            return new[]
            {
                new SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chainMass - MassDiffDictionary.OxygenMass - CD2), 100d, "-CH2(Sn1)") { SpectrumComment = SpectrumComment.snposition },
                new SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chainMass - H2O - MassDiffDictionary.HydrogenMass - MassDiffDictionary.OxygenMass - CD2), 100d, "-H2O -CH2(Sn1)") { SpectrumComment = SpectrumComment.snposition },
            };
        }
