    ...
    public class LPSd5OadSpectrumGenerator : ILipidSpectrumGenerator {
        ...
        public bool CanGenerate(ILipid lipid, AdductIon adduct) {
            if (lipid.LipidClass == LbmClass.LPS_d5) {
                if (adduct.AdductIonName == "[M+H]+" || adduct.AdductIonName == "[M-H]-") {
                    return true;
                }
            }
            return false;
        ...
        private SpectrumPeak[] GetLPSOadSpectrum(ILipid lipid, AdductIon adduct) {
            var spectrum = new List<SpectrumPeak> {
            ...
            if (adduct.AdductIonName == "[M+H]+") {
                ...
                (
                    new[] {
                        ...
                        new SpectrumPeak(adduct.ConvertToMz(C3H4D5O6P- MassDiffDictionary.HydrogenMass), 100d, "C3H4D5O6P - H"){ SpectrumComment = SpectrumComment.metaboliteclass },
