...
{
    public class PCd5SpectrumGenerator : ILipidSpectrumGenerator
    {
        ...
        public PCd5SpectrumGenerator()
        {
            spectrumGenerator = new SpectrumPeakGenerator();
        }

        public PCd5SpectrumGenerator(ISpectrumPeakGenerator spectrumGenerator)
        {
        ...
        {
            if (lipid.LipidClass == LbmClass.PC_d5)
            {
        ...
        private SpectrumPeak[] GetAcylPositionSpectrum(ILipid lipid, IChain acylChain, AdductIon adduct)
        {
            ...
            return new[]
            {
                new SpectrumPeak(adduct.ConvertToMz(lipidMass - chainMass - MassDiffDictionary.OxygenMass - CD2), 50d, "-CD2(Sn1)") { SpectrumComment = SpectrumComment.snposition },
            };
        }
