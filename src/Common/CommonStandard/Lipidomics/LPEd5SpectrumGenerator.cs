...
{
    public class LPEd5SpectrumGenerator : ILipidSpectrumGenerator
    {
        ...
        public LPEd5SpectrumGenerator() {
            spectrumGenerator = new SpectrumPeakGenerator();
        }

        public LPEd5SpectrumGenerator(ISpectrumPeakGenerator peakGenerator) {
        ...
        {
            if (lipid.LipidClass == LbmClass.LPE_d5)
            {
        ...
        private SpectrumPeak[] GetAcylPositionSpectrum(ILipid lipid, IChain acylChain, AdductIon adduct)
        {
            ...
            return new[]
            {
                new SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chainMass - MassDiffDictionary.OxygenMass - CD2 - MassDiffDictionary.HydrogenMass), 100d, "-CD2(Sn1)") { SpectrumComment = SpectrumComment.snposition },
            };
        }
