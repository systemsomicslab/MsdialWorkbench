...
namespace CompMs.MsdialCore.Utility {
    public sealed class DataAccess {
        ...
        public static RawMeasurement LoadMeasurement(AnalysisFileBean file, bool isImagingMsData, bool isGuiProcess, int retry, int sleepMilliSeconds, bool isNewProcess = false) {
            using (var access = new RawDataAccess(file.AnalysisFilePath, 0, false, isImagingMsData, isGuiProcess, file.RetentionTimeCorrectionBean.PredictedRt, isNewProcessInMaldiImagingAnalyais: isNewProcess)) {
