...
{
    /// <summary>
    /// Interaction logic for MsdialProcessingTab.xaml
    /// </summary>
    public partial class MsdialProcessingTab : RibbonTab
    {
        ...
        private void generateGraph_Click(object sender, RoutedEventArgs e)
        {
            ...
            MessageBox.Show("Graph generated and saved as 'my_graph.png'");
        }
