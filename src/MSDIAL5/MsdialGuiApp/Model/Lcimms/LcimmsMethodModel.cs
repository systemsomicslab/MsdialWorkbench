...
namespace CompMs.App.Msdial.Model.Lcimms
{
    internal sealed class LcimmsMethodModel : MethodModelBase
    {
        ...
        public CheckChromatogramsModel? PrepareChromatograms(bool tic, bool bpc, bool highestEic) {
            ...
            var model = new CheckChromatogramsModel(loadChromatogramsUsecase, analysisModel.AccumulateSpectraUsecase, Storage.Parameter.AdvancedProcessOptionBaseParam);
            model.Update();
            return model;
        }
    }
