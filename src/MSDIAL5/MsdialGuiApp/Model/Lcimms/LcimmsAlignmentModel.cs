    ...
    internal sealed class LcimmsAlignmentModel : AlignmentModelBase
    {
        ...
        public LcimmsAlignmentModel(
            ...
            CompoundSearchModel = target
                .CombineLatest(MsdecResult, (t, r) => t is null || r is null ? null : new LcimmsCompoundSearchModel(_files[t.RepresentativeFileID], new PeakSpotModel(t, r), new LcimmsCompoundSearchService(searcherCollection.Items), new SetAnnotationService(t, t.MatchResultsModel, _undoManager)))
