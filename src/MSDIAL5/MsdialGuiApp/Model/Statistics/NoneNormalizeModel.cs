...
namespace CompMs.App.Msdial.Model.Statistics
{
    internal sealed class NoneNormalizeModel : BindableBase
    {
        ...
        public NoneNormalizeModel(AlignmentResultContainer container, InternalStandardSetModel internalStandardSetModel, IReadOnlyList<AnalysisFileBean> files, IMessageBroker messageBroker) {
        ...
        public void Normalize(bool applyDilutionFactor) {
            ...
            using (publisher.Start()) {
                Normalization.None(_files, _internalStandardSetModel.Spots, applyDilutionFactor);
