...
namespace CompMs.App.Msdial.Model.Search {
    internal sealed class InternalMsFinder : DisposableModelBase {
        public InternalMsFinder(List<MsfinderQueryFile> msfinderQueryFiles, AnalysisParamOfMsfinder parameter, List<ExistStructureQuery> structureQueries) {
            ...
            var internalMsFinderMs1 = new ObservableMsSpectrum(_selectedObservedMetabolite._ms1SpectrumSubject, null, Observable.Return<ISpectraExporter?>(null)).AddTo(Disposables);
            ...
            var internalMsFinderMs2 = new ObservableMsSpectrum(_selectedObservedMetabolite._ms2SpectrumSubject, null, Observable.Return<ISpectraExporter?>(null)).AddTo(Disposables);
            ...
            var structureMs2 = new ObservableMsSpectrum(_selectedObservedMetabolite._ms2SpectrumSubject, null, Observable.Return<ISpectraExporter?>(null)).AddTo(Disposables);
            ...
            var structureRef = new ObservableMsSpectrum(_selectedObservedMetabolite._refSpectrum, null, Observable.Return<ISpectraExporter?>(null)).AddTo(Disposables);
