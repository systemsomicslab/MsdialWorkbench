...
namespace CompMs.App.Msdial.Model.Dims
{
    internal sealed class DimsAlignmentModel : AlignmentModelBase
    {
        ...
        public DimsAlignmentModel(
            ...
            var filter = peakSpotFiltering.CreateFilter(peakFilterModel, evaluator.Contramap<AlignmentSpotPropertyModel, MsScanMatchResult>(filterable => filterable.ScanMatchResult, (e, f) => f.IsRefMatched(e), (e, f) => f.IsSuggested(e)), status: ~(FilterEnableStatus.Rt | FilterEnableStatus.Dt));
            ...
            _molecularNetworkingService = new MolecularNetworkingService(alignmentFileModel, _broker, filter, AlignmentSpotSource.Spots!.Items, Target);
