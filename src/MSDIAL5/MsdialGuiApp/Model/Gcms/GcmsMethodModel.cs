...
namespace CompMs.App.Msdial.Model.Gcms
{
    internal sealed class GcmsMethodModel : MethodModelBase
    {
        ...
        public CheckChromatogramsModel? ShowChromatograms(bool tic, bool bpc, bool highestEic) {
            ...
            var model = new CheckChromatogramsModel(loadChromatogramsUsecase, analysisModel.AccumulateSpectraUsecase, null, _storage.Parameter.AdvancedProcessOptionBaseParam, _broker);
            model.Update();
            return model;
        }
