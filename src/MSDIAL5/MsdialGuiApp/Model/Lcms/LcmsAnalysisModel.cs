...
namespace CompMs.App.Msdial.Model.Lcms
{
    internal sealed class LcmsAnalysisModel : AnalysisModelBase {
        ...
        public LcmsAnalysisModel(
            ...
            SingleSpectrumModel rawSpectrumModel = SingleSpectrumModel.Create(Target, rawSpectrumLoader, horizontalPropertySelector, verticalPropertySelector, measuredHueItem, rawGraphLabels, Observable.Return(spectraExporter)).AddTo(Disposables);
            ...
            SingleSpectrumModel referenceSpectrumModel = SingleSpectrumModel.Create(MatchResultCandidatesModel.SelectedCandidate, refLoader, horizontalPropertySelector, verticalPropertySelector, referenceSpectrumHueItem, refGraphLabels, Observable.Return((ISpectraExporter)null)).AddTo(Disposables);
