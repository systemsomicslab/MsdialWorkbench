...
namespace CompMs.App.Msdial.Model.Lcms
{
    internal sealed class LcmsAnalysisModel : AnalysisModelBase {
        ...
        public LcmsAnalysisModel(
            ...
            SingleSpectrumModel rawSpectrumModel = new SingleSpectrumModel(ObservableMsSpectrum.Create(Target, rawSpectrumLoader, Observable.Return(spectraExporter)).AddTo(Disposables), horizontalPropertySelector, verticalPropertySelector, measuredHueItem, rawGraphLabels).AddTo(Disposables);
            ...
            SingleSpectrumModel decSpectrumModel = new SingleSpectrumModel(ObservableMsSpectrum.Create(Target, decLoader_, Observable.Return(spectraExporter)).AddTo(Disposables), horizontalPropertySelector, verticalPropertySelector, measuredHueItem, decGraphLabels).AddTo(Disposables);
