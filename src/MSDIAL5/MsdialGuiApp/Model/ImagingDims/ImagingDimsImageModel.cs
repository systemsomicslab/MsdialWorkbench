...
internal sealed class ImagingDimsImageModel : DisposableModelBase
{
    private readonly IMessageBroker _broker;
    private int _roiId = 0;
    private readonly SemaphoreSlim _semaphoreSlim;

    public ImagingDimsImageModel(AnalysisFileBeanModel file, IMsdialDataStorage<MsdialDimsParameter> storage, IMatchResultEvaluator<MsScanMatchResult> evaluator, IDataProviderFactory<AnalysisFileBean> providerFactory, FilePropertiesModel projectBaseParameterModel, IMessageBroker broker) {
