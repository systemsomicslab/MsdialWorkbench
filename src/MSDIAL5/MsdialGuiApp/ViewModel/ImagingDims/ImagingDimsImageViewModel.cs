...
internal sealed class ImagingDimsImageViewModel : ViewModelBase
{
    private readonly ImagingDimsImageModel _model;

    public ImagingDimsImageViewModel(ImagingDimsImageModel model, FocusControlManager focusManager, IMessageBroker broker, IWindowService<PeakSpotTableViewModelBase> peakSpotTableService) {
