...
{
    internal sealed class GcmsAlignmentCompoundSearchViewModel : CompoundSearchVM<PeakSpotModel>
    {
        private readonly ReadOnlyReactivePropertySlim<bool> _parameterHasErrors;

        public GcmsAlignmentCompoundSearchViewModel(CompoundSearchModel<PeakSpotModel> model) : base(model) {
