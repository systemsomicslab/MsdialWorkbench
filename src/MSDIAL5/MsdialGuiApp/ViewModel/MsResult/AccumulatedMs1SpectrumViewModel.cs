...
internal sealed class AccumulatedMs1SpectrumViewModel : ViewModelBase, IDialogPropertiesViewModel
{
    public AccumulatedMs1SpectrumViewModel(AccumulatedMs1SpectrumModel model)
    {
        ...
        ViewModels = [
            new AccumulatedMs1SpectrumViewModel_Spectrum(MsSpectrumViewModel, SelectedRange, SaveAsNistCommand, CalculateExtractedIonChromatogramCommand),
            new AccumulatedMs1SpectrumViewModel_Search(model.SearchMethods, SearchMethod, ParameterViewModel, Compounds, SelectedCompound, SearchCompoundCommand, ImportDataBaseCommand, ExportCompoundCommand),
            new AccumulatedMs1SpectrumViewModel_Chromatogram(ExtractedIonChromatogram, ProductIonRange, DetectPeaksCommand, AddPeakCommand, ResetPeaksCommand),
        ];
    }
    ...
    string? IDialogPropertiesViewModel.Title => $"Accumulated MS1 Spectrum, {Model.FileModel.AnalysisFileName}";
    double? IDialogPropertiesViewModel.Width => null;
    double? IDialogPropertiesViewModel.Height => null;
}

internal class AccumulatedMs1SpectrumViewModel_Spectrum(
...
internal class AccumulatedMs1SpectrumViewModel_Search(
    IList searchMethods,
...
internal class AccumulatedMs1SpectrumViewModel_Chromatogram(
