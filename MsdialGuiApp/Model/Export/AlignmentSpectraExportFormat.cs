...
namespace CompMs.App.Msdial.Model.Export
{
    internal sealed class AlignmentSpectraExportFormat : BindableBase {
        ...
        public void Export(AlignmentResultContainer container, IReadOnlyList<MSDecResult> msdecResults, string fileNameTemplate, string exportDirectory, Action<string> notification) {
            ...
            using (var stream = File.Open(outPath, FileMode.Create, FileAccess.Write)) {
                _exporter.Export(stream, container.AlignmentSpotProperties, msdecResults);
            }
        }
    }
}
