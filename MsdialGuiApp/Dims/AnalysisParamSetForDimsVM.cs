...
namespace CompMs.App.Msdial.Dims
{
    class AnalysisParamSetForDimsVM : ViewModelBase {
        #region Property
        public MsdialDimsParameterVM Param {
            get => paramVM;
        ...
        public AnalysisParamSetForDimsVM(MsdialDimsParameter parameter, IEnumerable<AnalysisFileBean> files) {
            param = parameter;
            Param = new MsdialDimsParameterVM(parameter);
        ...
        public DelegateCommand<Window> ContinueProcessCommand {
            get => continueProcessCommand ?? (continueProcessCommand = new DelegateCommand<Window>(ContinueProcess, ValidateAnalysisParamSetForDimsWindow));
        }
        ...
        private bool ValidateAnalysisParamSetForDimsWindow(Window window) {
    ...
    class MsdialDimsParameterVM : ParameterBaseVM
    {
        private readonly MsdialDimsParameter innerModel;
        public MsdialDimsParameterVM(MsdialDimsParameter innerModel) : base(innerModel) {
