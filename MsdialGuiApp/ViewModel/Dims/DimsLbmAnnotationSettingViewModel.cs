...
{
    public sealed class DimsLbmAnnotationSettingViewModel : ViewModelBase, IAnnotationSettingViewModel
    {
        public DimsLbmAnnotationSettingViewModel(DataBaseAnnotationSettingModelBase other, ParameterBase parameter) {
            model = new DimsLbmAnnotationSettingModel(other, parameter);
            ...
            Label = Observable.Return("DimsLbmAnnotator").ToReadOnlyReactivePropertySlim().AddTo(Disposables);
        ...
        private readonly DimsLbmAnnotationSettingModel model;
