...
{
    class LcimmsAnalysisParamSetVM : AnalysisParamSetVM<MsdialLcImMsParameter>
    {
        public LcimmsAnalysisParamSetVM(MsdialLcImMsParameter parameter, IEnumerable<AnalysisFileBean> files) : base(parameter, files) {
